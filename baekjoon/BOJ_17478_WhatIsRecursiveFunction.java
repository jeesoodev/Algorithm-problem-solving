...
public class BOJ_17478_WhatIsRecursiveFunction {
    ...
    private static void askAndAnswer(int cnt) {
        ...
        sb.append(underBar).append("\"재귀함수가 뭔가요?\"").append("\n")
                .append(underBar).append("\"잘 들어보게. 옛날옛날 한 산 꼭대기에 이세상 모든 지식을 통달한 선인이 있었어.\n")
